...
Namespace ApiExamples.Document
	...
	Public Class ExInsertDocument
		...
		Private Shared Sub InsertDocument(ByVal insertAfterNode As Aspose.Words.Node, ByVal srcDoc As Aspose.Words.Document)
			...
			For Each srcSection As Aspose.Words.Section In srcDoc.Sections
				...
				For Each srcNode As Aspose.Words.Node In srcSection.Body
					...
					Dim newNode As Aspose.Words.Node = importer.ImportNode(srcNode, True)
		...
		Public Sub InsertDocumentAtBookmark()
			...
			Dim mainDoc As New Aspose.Words.Document(MyDir & "InsertDocument1.doc")
			Dim subDoc As New Aspose.Words.Document(MyDir & "InsertDocument2.doc")

			Dim bookmark As Aspose.Words.Bookmark = mainDoc.Range.Bookmarks("insertionPlace")
		...
		Private Class InsertDocumentAtMailMergeHandler
			...
			Private Sub IFieldMergingCallback_FieldMerging(ByVal e As FieldMergingArgs) Implements IFieldMergingCallback.FieldMerging
				If e.DocumentFieldName = "Document_1" Then
					...
					Dim subDoc As New Aspose.Words.Document(CStr(e.FieldValue))
		...
		Private Class InsertDocumentAtMailMergeBlobHandler
			...
			Private Sub IFieldMergingCallback_FieldMerging(ByVal e As FieldMergingArgs) Implements IFieldMergingCallback.FieldMerging
				If e.DocumentFieldName = "Document_1" Then
					...
					Dim subDoc As New Aspose.Words.Document(stream)
