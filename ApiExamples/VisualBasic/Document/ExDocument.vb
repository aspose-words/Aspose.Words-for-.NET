...
Namespace ApiExamples.Document
	...
	Public Class ExDocument
		...
		Public Sub OpenFromStreamWithBaseUri()
			...
			Dim doc As New Aspose.Words.Document(stream, loadOptions)
		...
		Public Sub OpenDocumentFromWeb()
			...
			Dim doc As New Aspose.Words.Document(byteStream)
		...
		Public Sub InsertHtmlFromWebPage()
			...
			Dim doc As New Aspose.Words.Document(stream, options)
		...
		Public Sub LoadFormat()
			...
			Dim doc As New Aspose.Words.Document(MyDir & "Document.LoadFormat.html", loadOptions)
			'ExEnd
		End Sub
		...
		Public Sub LoadEncryptedFromFile()
			...
			Dim doc As New Aspose.Words.Document(MyDir & "Document.LoadEncrypted.doc", New LoadOptions("qwerty"))
			'ExEnd
		End Sub
		...
		Public Sub LoadEncryptedFromStream()
			...
			Dim doc As New Aspose.Words.Document(stream, New LoadOptions("qwerty"))
			stream.Close()
			'ExEnd
		End Sub
		...
		Public Sub Doc2EpubSave()
			...
			Dim doc As New Aspose.Words.Document(MyDir & "Document.EpubConversion.doc")
		...
		Public Sub SaveHtmlWithOptions()
			...
			Dim doc As New Aspose.Words.Document(MyDir & "Rendering.doc")
		...
		Public Sub AppendDocument()
			...
			Dim dstDoc As New Aspose.Words.Document(MyDir & "Document.doc")
			' The document to append.
			Dim srcDoc As New Aspose.Words.Document(MyDir & "DocumentBuilder.doc")
		...
		Public Sub AppendDocumentFromAutomation()
			...
			For i As Integer = 1 To recordCount
				...
				Dim srcDoc As New Aspose.Words.Document("C:\DetailsList.doc")
		...
		Public Sub ValidateAllDocumentSignatures()
			...
			Dim doc As New Aspose.Words.Document(MyDir & "Document.Signed.docx")
		...
		Public Sub ValidateIndividualDocumentSignatures()
			...
			For Each signature As Aspose.Words.DigitalSignature In doc.DigitalSignatures
			...
			Dim digitalSig As Aspose.Words.DigitalSignature = doc.DigitalSignatures(0)
		...
		Public Sub AppendAllDocumentsInFolder()
			...
			Dim baseDoc As New Aspose.Words.Document()
			...
			For Each fileName As String In files
				...
				Dim subDoc As New Aspose.Words.Document(fileName)
		...
		Public Sub CloneDocument()
			...
			Dim doc As New Aspose.Words.Document(MyDir & "Document.doc")
			Dim clone As Aspose.Words.Document = doc.Clone()
			'ExEnd
		End Sub
		...
		Public Sub TableStyleToDirectFormatting()
			...
			Dim doc As New Aspose.Words.Document(MyDir & "Table.TableStyle.docx")
		...
		Public Sub CompareEx()
			...
			Dim doc1 As New Aspose.Words.Document(MyDir & "Document.Compare.1.doc")
			Dim doc2 As New Aspose.Words.Document(MyDir & "Document.Compare.2.doc")
