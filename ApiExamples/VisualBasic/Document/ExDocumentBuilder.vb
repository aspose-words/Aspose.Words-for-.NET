...
Namespace ApiExamples.Document
	...
	Public Class ExDocumentBuilder
		...
		Public Sub WorkingWithNodes()
			...
			Dim doc As New Aspose.Words.Document(MyDir & "DocumentBuilder.WorkingWithNodes.doc")
			Dim builder As New DocumentBuilder(doc)
		...
		Public Sub FillingDocument()
			...
			Dim doc As New Aspose.Words.Document(MyDir & "DocumentBuilder.FillingDocument.doc")
			Dim builder As New DocumentBuilder(doc)
		...
		Public Sub DocumentBuilderCursorPosition()
			...
			Dim doc As New Aspose.Words.Document(MyDir & "DocumentBuilder.doc")
			Dim builder As New DocumentBuilder(doc)

			Dim curNode As Aspose.Words.Node = builder.CurrentNode
		...
		Public Sub DeleteRowEx()
			...
			Dim doc As New Aspose.Words.Document(MyDir & "DocumentBuilder.DocWithTable.doc")
			Dim builder As New DocumentBuilder(doc)
		...
		Public Sub InsertDocumentEx()
			...
			Dim builder As New DocumentBuilder(doc)
			Dim docToInsert As New Aspose.Words.Document(MyDir & "DocumentBuilder.InsertedDoc.doc")
		...
		Public Sub EditableRangeEx()
			...
			Dim editableRange2 As Aspose.Words.EditableRange = edRange2Start.EditableRange
		...
		Public Sub InsertChartDoubleEx()
			...
			builder.InsertChart(ChartType.Pie, Aspose.Words.ConvertUtil.PixelToPoint(300), Aspose.Words.ConvertUtil.PixelToPoint(300))
