...
Namespace ApiExamples.Document
	...
	Public Class ExVisitor
		...
		Public Sub ToText()
			...
			Dim doc As New Aspose.Words.Document(MyDir & "Visitor.ToText.doc")
		...
		Public Class MyDocToTxtWriter
			...
			Public Overrides Function VisitBodyStart(ByVal body As Body) As VisitorAction
				...
				mBuilder.Append("*** Body Started ***" & Constants.vbCrLf)

				Return VisitorAction.Continue
			End Function

			Public Overrides Function VisitBodyEnd(ByVal body As Body) As VisitorAction
				mBuilder.Append("*** Body Ended ***" & Constants.vbCrLf)
				Return VisitorAction.Continue
			End Function
			...
			''' </summary>
			Public Overrides Function VisitHeaderFooterStart(ByVal headerFooter As Aspose.Words.HeaderFooter) As VisitorAction
			...
			Public Overrides Function VisitAbsolutePositionTab(ByVal tab As AbsolutePositionTab) As VisitorAction
				mBuilder.Append(Constants.vbTab)
				Return VisitorAction.Continue
			End Function
