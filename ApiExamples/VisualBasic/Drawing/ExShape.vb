...
Namespace ApiExamples.Drawing
	...
	Public Class ExShape
		...
		Public Sub DeleteAllShapes()
			Dim doc As New Aspose.Words.Document(MyDir & "Shape.DeleteAllShapes.doc")
		...
		Public Sub ReplaceTextboxesWithImages()
			...
			Dim doc As New Aspose.Words.Document(MyDir & "Shape.ReplaceTextboxesWithImages.doc")
			...
			Dim shapes() As Aspose.Words.Node = shapeCollection.ToArray()
