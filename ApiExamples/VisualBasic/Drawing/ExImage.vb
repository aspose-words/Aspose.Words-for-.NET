...
Namespace ApiExamples.Drawing
	...
	Public Class ExImage
		...
		Public Sub CreateFromImage()
			...
			Dim metafile As System.Drawing.Image = System.Drawing.Image.FromFile(MyDir & "Hammer.wmf")
			Try
		...
		Public Sub DeleteAllImages()
			Dim doc As New Aspose.Words.Document(MyDir & "Image.SampleImages.doc")
		...
		Public Sub DeleteAllImagesPreOrder()
			...
			Dim curNode As Aspose.Words.Node = doc
			Do While curNode IsNot Nothing
				Dim nextNode As Aspose.Words.Node = curNode.NextPreOrder(doc)
