...
Namespace ApiExamples.Tables
	...
	Public Class ExTable
		...
		Public Sub DisplayContentOfTables()
			...
			Dim doc As New Aspose.Words.Document(MyDir & "Table.Document.doc")
		...
		Public Sub CalcuateDepthOfNestedTables()
			Dim doc As New Aspose.Words.Document(MyDir & "Table.NestedTables.doc")
		...
		Private Shared Function GetNestedDepthOfTable(ByVal table As Table) As Integer
			...
			Dim parent As Aspose.Words.Node = table.GetAncestor(type)
		...
		Public Sub ConvertTextboxToTable()
			' Open the document
			Dim doc As New Aspose.Words.Document(MyDir & "Shape.Textbox.doc")
		...
		Private Shared Sub ConvertTextboxToTable(ByVal textBox As Shape)
			...
			Dim doc As Aspose.Words.Document = CType(textBox.Document, Aspose.Words.Document)
			Dim section As Aspose.Words.Section = CType(textBox.GetAncestor(NodeType.Section), Aspose.Words.Section)
			...
			Dim shapeParent As Aspose.Words.Node = textBox.ParentNode
			...
			For Each node As Aspose.Words.Node In textBox.GetChildNodes(NodeType.Any, False).ToArray()
		...
		Public Sub SetTableBordersOutline()
			...
			Dim doc As New Aspose.Words.Document(MyDir & "Table.EmptyTable.doc")
		...
		Public Sub ReplaceTextInTable()
			...
			Dim doc As New Aspose.Words.Document(MyDir & "Table.SimpleTable.doc")
		...
		Public Sub RowFormatDisableBreakAcrossPages()
			Dim doc As New Aspose.Words.Document(MyDir & "Table.TableAcrossPage.doc")
		...
		''' </summary>
		Private Function CreateTable(ByVal doc As Aspose.Words.Document, ByVal rowCount As Integer, ByVal cellCount As Integer, ByVal cellText As String) As Table
			Dim table As New Table(doc)
		...
		Public Sub CheckCellsMerged()
			Dim doc As New Aspose.Words.Document(MyDir & "Table.MergedCells.doc")
