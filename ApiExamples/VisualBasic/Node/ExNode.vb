...
Namespace ApiExamples.Node
	...
	Public Class ExNode
		...
		Public Sub CloneCompositeNode()
			...
			Dim cloneWithChildren As Aspose.Words.Node = para.Clone(True)
			' Only clone the paragraph and no child nodes.
			Dim cloneWithoutChildren As Aspose.Words.Node = para.Clone(False)
			'ExEnd
		...
		Public Sub RecurseAllNodes()
			' Open a document.
			Dim doc As New Aspose.Words.Document(MyDir & "Node.RecurseAllNodes.doc")
		...
		Public Sub RemoveNodes()
			...
			Dim curNode As Aspose.Words.Node = body.FirstChild
		...
		Public Sub EnumNextSibling()
			...
			Dim node As Aspose.Words.Node = body.FirstChild
		...
		Public Sub RemoveChild()
			...
			Dim lastSection As Aspose.Words.Node = doc.LastChild
			...
			Dim sectionBeforeLast As Aspose.Words.Node = lastSection.PreviousSibling
		...
		Public Sub CompositeNode_SelectNodes()
			...
			Dim node As Aspose.Words.Node = doc.SelectSingleNode("//Body/Paragraph")
			'ExEnd
		End Sub
		...
		Public Sub TestNodeIsInsideField()
			...
			Dim doc As New Aspose.Words.Document(MyDir & "MailMerge.MergeImage.doc")
			...
			For Each node As Aspose.Words.Node In resultList
				If node Is run Then
		...
		Public Sub GetNodeTypeEnums()
			...
			Dim node As Aspose.Words.Node = doc.FirstSection.Body.FirstParagraph.FirstChild
		...
		Public Sub ConvertNodeToHtmlWithDefaultOptions()
			...
			Dim node As Aspose.Words.Node = doc.LastSection.Body.LastParagraph
