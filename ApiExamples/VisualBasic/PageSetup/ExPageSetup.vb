...
Namespace ApiExamples.PageSetup
	...
	Public Class ExPageSetup
		...
		Public Sub PageBorderProperties()
			...
			Dim ps As Aspose.Words.PageSetup = doc.Sections(0).PageSetup
			...
			Dim border As Aspose.Words.Border = ps.Borders(BorderType.Top)
		...
		Public Sub PageNumbering()
			...
			Dim doc As New Aspose.Words.Document(MyDir & "PageSetup.PageNumbering.doc")
