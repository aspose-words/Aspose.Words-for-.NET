...
Namespace ApiExamples.Style
	...
	Public Class ExStyles
		...
		Public Sub GetStyles()
			...
			For Each style As Aspose.Words.Style In styles
		...
		Public Sub SetAllStyles()
			...
			Dim doc As New Aspose.Words.Document()
			For Each style As Aspose.Words.Style In doc.Styles
		...
		Public Sub CopyStyleSameDocument()
			...
			Dim newStyle As Aspose.Words.Style = doc.Styles.AddCopy(doc.Styles("Heading 1"))
		...
		Public Sub CopyStyleDifferentDocument()
			...
			Dim srcStyle As Aspose.Words.Style = srcDoc.Styles(StyleIdentifier.Heading1)

			' Change the font of the heading style to red.
			srcStyle.Font.Color = Color.Red

			' The AddCopy method can be used to copy a style from a different document.
			Dim newStyle As Aspose.Words.Style = dstDoc.Styles.AddCopy(srcStyle)
			'ExEnd
