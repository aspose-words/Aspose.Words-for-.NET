...
Namespace ApiExamples.Border
	...
	Public Class ExBorder
		...
		Public Sub ParagraphTopBorder()
			...
			Dim topBorder As Aspose.Words.Border = builder.ParagraphFormat.Borders(BorderType.Top)
		...
		Public Sub ClearFormattingEx()
			...
			Dim doc As New Aspose.Words.Document(MyDir & "Document.Borders.doc")
			Dim builder As New DocumentBuilder(doc)
			Dim borders As BorderCollection = builder.ParagraphFormat.Borders

			For Each border As Aspose.Words.Border In borders
