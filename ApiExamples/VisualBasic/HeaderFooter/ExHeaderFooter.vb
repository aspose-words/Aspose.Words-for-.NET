...
Namespace ApiExamples.HeaderFooter
	...
	Public Class ExHeaderFooter
		...
		Public Sub CreateFooter()
			...
			Dim footer As New Aspose.Words.HeaderFooter(doc, HeaderFooterType.FooterPrimary)
		...
		Public Sub RemoveFooters()
			...
			Dim doc As New Aspose.Words.Document(MyDir & "HeaderFooter.RemoveFooters.doc")
		...
		Public Sub ReplaceText()
			...
			Dim doc As New Aspose.Words.Document(MyDir & "HeaderFooter.ReplaceText.doc")

			Dim headersFooters As HeaderFooterCollection = doc.FirstSection.HeadersFooters
			Dim footer As Aspose.Words.HeaderFooter = headersFooters(HeaderFooterType.FooterPrimary)
		...
		Public Sub Primer()
			...
			Dim primaryFooter As Aspose.Words.HeaderFooter = currentSection.HeadersFooters(HeaderFooterType.FooterPrimary)
		...
		''' </summary>
		Private Shared Sub CopyHeadersFootersFromPreviousSection(ByVal section As Aspose.Words.Section)
			Dim previousSection As Aspose.Words.Section = CType(section.PreviousSibling, Aspose.Words.Section)
			...
			For Each headerFooter As Aspose.Words.HeaderFooter In previousSection.HeadersFooters
