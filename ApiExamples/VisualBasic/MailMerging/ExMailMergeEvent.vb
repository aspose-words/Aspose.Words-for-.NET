...
Namespace ApiExamples.MailMerging
	...
	Public Class ExMailMergeEvent
		...
		Public Sub MailMergeInsertHtml()
			Dim doc As New Aspose.Words.Document(MyDir & "MailMerge.InsertHtml.doc")
		...
		Public Sub MailMergeInsertCheckBox()
			Dim doc As New Aspose.Words.Document(MyDir & "MailMerge.InsertCheckBox.doc")
		...
		Public Sub MailMergeAlternatingRows()
			Dim doc As New Aspose.Words.Document(MyDir & "MailMerge.AlternatingRows.doc")
		...
		Public Sub MailMergeImageFromUrl()
			...
			Dim doc As New Aspose.Words.Document(MyDir & "MailMerge.MergeImageSimple.doc")
