...
Namespace ApiExamples.MailMerging
	...
	Public Class ExMailMerge
		...
		Public Sub ExecuteArray()
			...
			Dim doc As New Aspose.Words.Document(MyDir & "MailMerge.ExecuteArray.doc")
		...
		Public Sub ExecuteDataTable()
			...
			Dim doc As New Aspose.Words.Document(MyDir & "MailMerge.ExecuteDataTable.doc")
		...
		Public Sub ExecuteDataReader()
			...
			Dim doc As New Aspose.Words.Document(MyDir & "MailingLabelsDemo.doc")
		...
		Public Sub ExecuteDataView()
			...
			Dim doc As New Aspose.Words.Document(MyDir & "MailMerge.ExecuteDataView.doc")
		...
		Public Sub ExecuteWithRegionsDataSet()
			...
			Dim doc As New Aspose.Words.Document(MyDir & "MailMerge.ExecuteWithRegions.doc")
