...
Namespace ApiExamples.Section
	...
	Public Class ExSection
		...
		Public Sub AddRemove()
			...
			' Open the document.
			Dim doc As New Aspose.Words.Document(MyDir & "Section.AddRemove.doc")
			...
			Dim newSection As Aspose.Words.Section = doc.Sections(lastSectionIdx).Clone()
		...
		Public Sub CreateFromScratch()
			...
			Dim section As New Aspose.Words.Section(doc)
		...
		Public Sub EnsureSectionMinimum()
			...
			' Create a blank document
			Dim doc As New Aspose.Words.Document()
			Dim section As Aspose.Words.Section = doc.FirstSection
		...
		Public Sub BodyEnsureMinimum()
			...
			' Open a document.
			Dim doc As New Aspose.Words.Document(MyDir & "Section.BodyEnsureMinimum.doc")
		...
		Public Sub BodyNodeType()
			...
			' Open a document.
			Dim doc As New Aspose.Words.Document(MyDir & "Section.BodyNodeType.doc")
			...
			For Each node As Aspose.Words.Node In section
				...
				Select Case node.NodeType
					...
					Case NodeType.HeaderFooter
						...
						Dim headerFooter As Aspose.Words.HeaderFooter = CType(node, Aspose.Words.HeaderFooter)
		...
		Public Sub SectionsAccessByIndex()
			...
			Dim section As Aspose.Words.Section = doc.Sections(0)
			'ExEnd
		End Sub
		...
		Public Sub SectionsAddSection()
			...
			Dim doc As New Aspose.Words.Document(MyDir & "Document.doc")
			Dim sectionToAdd As New Aspose.Words.Section(doc)
		...
		Public Sub SectionsAppendSectionContent()
			...
			Dim doc As New Aspose.Words.Document(MyDir & "Section.AppendContent.doc")

			' This is the section that we will append and prepend to.
			Dim section As Aspose.Words.Section = doc.Sections(2)

			' This copies content of the 1st section and inserts it at the beginning of the specified section.
			Dim sectionToPrepend As Aspose.Words.Section = doc.Sections(0)
			section.PrependContent(sectionToPrepend)

			' This copies content of the 2nd section and inserts it at the end of the specified section.
			Dim sectionToAppend As Aspose.Words.Section = doc.Sections(1)
		...
		Public Sub SectionsCloneSection()
			...
			Dim doc As New Aspose.Words.Document(MyDir & "Document.doc")
			Dim cloneSection As Aspose.Words.Section = doc.Sections(0).Clone()
			'ExEnd
		End Sub
		...
		Public Sub SectionsImportSection()
			...
			Dim srcDoc As New Aspose.Words.Document(MyDir & "Document.doc")
			Dim dstDoc As New Aspose.Words.Document()

			Dim sourceSection As Aspose.Words.Section = srcDoc.Sections(0)
			Dim newSection As Aspose.Words.Section = CType(dstDoc.ImportNode(sourceSection, True), Aspose.Words.Section)
		...
		Public Sub MigrateFrom2XImportSection()
			Dim srcDoc As New Aspose.Words.Document()
			Dim dstDoc As New Aspose.Words.Document()
		...
		Public Sub ModifyPageSetupInAllSections()
			...
			Dim doc As New Aspose.Words.Document(MyDir & "Section.ModifyPageSetupInAllSections.doc")
			...
			For Each section As Aspose.Words.Section In doc
				section.PageSetup.PaperSize = PaperSize.Letter
			Next section
