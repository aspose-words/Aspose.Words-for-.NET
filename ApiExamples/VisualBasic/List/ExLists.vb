...
Namespace ApiExamples.List
	...
	Public Class ExLists
		...
		Public Sub NestedLists()
			...
			Dim outlineList As Aspose.Words.Lists.List = doc.Lists.Add(ListTemplate.OutlineNumbers)
			builder.ListFormat.List = outlineList
			builder.ParagraphFormat.StyleIdentifier = StyleIdentifier.Heading1
			builder.Writeln("This is my Chapter 1")

			' Create a numbered list.
			Dim numberedList As Aspose.Words.Lists.List = doc.Lists.Add(ListTemplate.NumberDefault)
			builder.ListFormat.List = numberedList
			builder.ParagraphFormat.StyleIdentifier = StyleIdentifier.Normal
			builder.Writeln("Numebered list item 1.")

			' Create a bulleted list.
			Dim bulletedList As Aspose.Words.Lists.List = doc.Lists.Add(ListTemplate.BulletDefault)
		...
		Public Sub RestartNumberingUsingListCopy()
			...
			Dim list1 As Aspose.Words.Lists.List = doc.Lists.Add(ListTemplate.NumberArabicParenthesis)
			...
			Dim list2 As Aspose.Words.Lists.List = doc.Lists.AddCopy(list1)
		...
		Public Sub CreateAndUseListStyle()
			...
			Dim listStyle As Aspose.Words.Style = doc.Styles.Add(StyleType.List, "MyListStyle")
			...
			Dim list1 As Aspose.Words.Lists.List = listStyle.List
			...
			Dim list2 As Aspose.Words.Lists.List = doc.Lists.Add(listStyle)
			...
			Dim list3 As Aspose.Words.Lists.List = doc.Lists.Add(listStyle)
		...
		Public Sub ApplyNewListToParagraphs()
			...
			Dim list As Aspose.Words.Lists.List = doc.Lists.Add(ListTemplate.NumberUppercaseLetterDot)
		...
		Public Sub OutlineHeadingTemplates()
			...
			Dim list As Aspose.Words.Lists.List = doc.Lists.Add(ListTemplate.OutlineHeadingsArticleSection)
		...
		Private Shared Sub AddOutlineHeadingParagraphs(ByVal builder As DocumentBuilder, ByVal list As Aspose.Words.Lists.List, ByVal title As String)
			builder.ParagraphFormat.ClearFormatting()
		...
		Public Sub PrintOutAllLists()
			...
			Dim srcDoc As New Aspose.Words.Document(MyDir & "Lists.PrintOutAllLists.doc")
			...
			For Each srcList As Aspose.Words.Lists.List In srcDoc.Lists
				' This copies the list formatting from the source into the destination document.
				Dim dstList As Aspose.Words.Lists.List = dstDoc.Lists.AddCopy(srcList)
		...
		Private Shared Sub AddListSample(ByVal builder As DocumentBuilder, ByVal list As Aspose.Words.Lists.List)
		...
		Public Sub ListDocument()
			...
			Dim list As Aspose.Words.Lists.List = lists.Add(ListTemplate.BulletDefault)
		...
		Public Sub ParagraphStyleBulleted()
			...
			Dim style As Aspose.Words.Style = doc.Styles.Add(StyleType.Paragraph, "MyStyle1")
			style.Font.Size = 24
		...
		Public Sub GetListLabels()
			...
			Dim doc As New Aspose.Words.Document(MyDir & "Lists.PrintOutAllLists.doc")
