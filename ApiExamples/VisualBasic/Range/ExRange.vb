...
Namespace ApiExamples.Range
	...
	Public Class ExRange
		...
		Public Sub DeleteSelection()
			...
			' Open Word document.
			Dim doc As New Aspose.Words.Document(MyDir & "Range.DeleteSection.doc")
		...
		Public Sub ReplaceSimple()
			...
			' Open the document.
			Dim doc As New Aspose.Words.Document(MyDir & "Range.ReplaceSimple.doc")
		...
		Public Sub ReplaceWithInsertHtml()
			' Open the document.
			Dim doc As New Aspose.Words.Document(MyDir & "Range.ReplaceWithInsertHtml.doc")
		...
		Private Class ReplaceWithHtmlEvaluator
			...
			Private Function IReplacingCallback_Replacing(ByVal e As ReplacingArgs) As ReplaceAction Implements IReplacingCallback.Replacing
				Dim builder As New DocumentBuilder(CType(e.MatchNode.Document, Aspose.Words.Document))
		...
		Public Sub ReplaceWithEvaluator()
			Dim doc As New Aspose.Words.Document(MyDir & "Range.ReplaceWithEvaluator.doc")
		...
		Public Sub ChangeTextToHyperlinks()
			Dim doc As New Aspose.Words.Document(MyDir & "Range.ChangeTextToHyperlinks.doc")
		...
		Private Class ChangeTextToHyperlinksEvaluator
			Implements IReplacingCallback
			Friend Sub New(ByVal doc As Aspose.Words.Document)
