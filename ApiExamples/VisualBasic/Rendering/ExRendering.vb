...
Namespace ApiExamples.Rendering
	...
	Public Class ExRendering
		...
		Public Class MyPrintDocument
			...
			Public Sub New(ByVal document As Aspose.Words.Document)
				mDocument = document
			End Sub
...
'                float hardOffsetY = e.PageSettings.HardMarginY;
			...
			Private ReadOnly mDocument As Aspose.Words.Document
		...
		Public Sub SetPdfNumeralFormat()
			Dim doc As New Aspose.Words.Document(MyDir & "Rendering.NumeralFormat.doc")
			'ExStart
