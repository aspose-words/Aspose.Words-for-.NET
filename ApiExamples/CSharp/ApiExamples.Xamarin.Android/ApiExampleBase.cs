...
namespace ApiExamples
{
    ...
    public class ApiExampleBase
    {
        ...
        {
            gArtifactsDir = Path.Combine(mExternalAppPath, "Aspose.Data/Artifacts/");
            gMyDir = Path.Combine(mExternalAppPath, "Aspose.Data/");
            gImageDir = Path.Combine(mExternalAppPath, "Aspose.Data/Images/");
            gDatabaseDir = Path.Combine(mExternalAppPath, "Aspose.Data/Database/");
            gGoldsDir = Path.Combine(mExternalAppPath, "Aspose.Data/Golds/");
        }
