...
namespace ApiExamples
{
    ...
    public class ExHeaderFooter : ApiExampleBase
    {
        ...
        public void Link()
        {
            ...
            // to allow the linking section to display headers/footers of the linked section.
            doc.Sections[1].HeadersFooters.LinkToPrevious(true);

            // Each section will still have its own header/footer objects. When we link sections,
            // the linking section displays the linked section's header/footers while still keeping its own.
            ...
            // The second section already links to the header/footers of the first section,
        ...
        public void ExportMode()
        {
            ...
            // as they would when we open the document as a .docx using Microsoft Word.
        ...
        /// <summary>
        /// Records the contents of every node in which text that we are replacing with other text has been found.
