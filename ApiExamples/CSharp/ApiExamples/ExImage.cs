...
namespace ApiExamples
{
    ...
    public class ExImage : ApiExampleBase
    {
        ...
        public void CreateFromUrl()
        {
            ...
            builder.InsertImage(ImageDir + "Aspose logo dark background.jpg");
            builder.Writeln();
        ...
        public void CreateFromStream()
        {
            ...
            Stream stream = File.OpenRead(ImageDir + "Aspose logo dark background.jpg");
            try
            {
        ...
        public void CreateFromImage()
        {
            ...
            Image rasterImage = Image.FromFile(ImageDir + "Aspose logo dark background.jpg");
            try
            {
            ...
            Image metafile = Image.FromFile(ImageDir + "Aspose logo.wmf");
            try
            {
        ...
        public void CreateFromImageNetStandard2()
        {
            ...
            using (SKBitmap rasterImage = SKBitmap.Decode(ImageDir + "Aspose logo dark background.jpg"))
            {
                builder.Write("Raster image: ");
                builder.InsertImage(rasterImage);
                builder.Writeln();
        ...
        public void InsertImageWithHyperlink()
        {
            ...
            Shape shape = builder.InsertImage(ImageDir + "Aspose logo.wmf");
        ...
        public void CreateImageDirectly()
        {
            ...
            shape.ImageData.SetImage(ImageDir + "Aspose logo.wmf");
            shape.Width = 100;
            shape.Height = 100;
        ...
        public void CreateLinkedImage()
        {
            ...
            string imageFileName = ImageDir + "Aspose logo.wmf";
