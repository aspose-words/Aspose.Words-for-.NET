...
namespace ApiExamples
{
    ...
    public class ExDocument : ApiExampleBase
    {
        ...
        public void CreateMarkdownDocumentWithHeadings()
        {
        ...
        public void CreateMarkdownDocumentWithBlockquotes()
        {
            Document doc = new Document(ArtifactsDir + "MarkdownExample.md");
            DocumentBuilder builder = new DocumentBuilder(doc);
        ...
        public void CreateMarkdownDocumentWithHeadingBlockquotes()
        {
            Document doc = new Document(ArtifactsDir + "MarkdownExample.md");
            DocumentBuilder builder = new DocumentBuilder(doc);
        ...
        public void CreateMarkdownDocumentWithHorizontalRule()
        {
            Document doc = new Document(ArtifactsDir + "MarkdownExample.md");
            DocumentBuilder builder = new DocumentBuilder(doc);
