...
Namespace Examples
	...
	Public Class ExDocument
		...
		Public Sub LoadFormat()
			...
			Dim doc As New Document(MyDir & "Document.LoadFormat.html", loadOptions)
			'ExEnd
		End Sub
		...
		Public Sub JoinRunsWithSameFormatting()
			...
			Dim runsBefore As Integer = doc.GetChildNodes(NodeType.Run, True, False).Count
			...
			Dim runsAfter As Integer = doc.GetChildNodes(NodeType.Run, True, False).Count
		...
		<Test> _
		Public Sub DocumentGetText_ToTxt()
			'ExStart
