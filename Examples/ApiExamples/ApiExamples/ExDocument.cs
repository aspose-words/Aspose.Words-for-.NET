...
namespace ApiExamples
{
    ...
    public class ExDocument : ApiExampleBase
    {
        ...
        public void SupportHF()
        {
            ...
            {
                foreach (CompositeNode hf in s.Body)
                {
                    // Create a temporary document for rendering header content.
                    Document tmp = ConvertToImage(doc, hf);
                    tmp.Save(ArtifactsDir + $"hf_{sectIndex}.png");
                }
        ...
        public void RenderCell()
        {
            ...
            tmp.Save(ArtifactsDir + "RenderCell.png");
        }
