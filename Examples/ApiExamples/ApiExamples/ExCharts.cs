...
namespace ApiExamples
{
    ...
    public class ExCharts : ApiExampleBase
    {
        ...
        public void ChartTitle()
        {
            ...
            Assert.IsTrue(chartShape.HasChart);

            title = chartShape.Chart.Title;

            Assert.AreEqual("My Chart", title.Text);
            Assert.IsTrue(title.Overlay);
            Assert.IsTrue(title.Show);
        }
        ...
        public void DataLabelNumberFormat()
        {
            ...
            Assert.IsTrue(series.HasDataLabels);
            Assert.IsTrue(series.DataLabels.ShowValue);
        ...
        public void AxisProperties()
        {
            ...
            CollectionAssert.AreEqual(doc, xAxis.Document);
            ...
            Assert.IsFalse(chart.AxisX.ReverseOrder);
            ...
            Assert.IsFalse(chart.AxisX.TickLabels.IsAutoSpacing);
            Assert.AreEqual(1, chart.AxisX.TickMarkSpacing);
            Assert.IsTrue(chart.AxisX.Format.IsDefined);
            ...
            Assert.IsTrue(chart.AxisY.ReverseOrder);
            ...
            Assert.IsTrue(chart.AxisY.Format.IsDefined);
        }
        ...
        public void HideChartAxis()
        {
            ...
            Assert.IsTrue(chart.AxisX.Hidden);
            Assert.IsTrue(chart.AxisY.Hidden);
        }
        ...
        public void SetNumberFormatToChartAxis()
        {
            ...
            Assert.IsFalse(chart.AxisY.NumberFormat.IsLinkedToSource);
        ...
        public void DataLabelsBubbleChart()
        {
            ...
            Assert.IsTrue(dataLabels.ShowBubbleSize);
            Assert.IsTrue(dataLabels.ShowCategoryName);
            Assert.IsTrue(dataLabels.ShowSeriesName);
        ...
        public void DataLabelsPieChart()
        {
            ...
            Assert.IsTrue(dataLabels.ShowLeaderLines);
            Assert.IsTrue(dataLabels.ShowLegendKey);
            Assert.IsTrue(dataLabels.ShowPercentage);
            Assert.IsTrue(dataLabels.ShowValue);
            Assert.AreEqual("; ", dataLabels.Separator);
        }
        ...
        private static void ApplyDataLabels(ChartSeries series, int labelsCount, string numberFormat, string separator)
        {
            ...
            {
                Assert.IsFalse(series.DataLabels[i].IsVisible);
                ...
                Assert.IsFalse(series.DataLabels[i].IsHidden);
                Assert.IsFalse(series.DataLabels[i].ShowDataLabelsRange);

                series.DataLabels[i].NumberFormat.FormatCode = numberFormat;
                series.DataLabels[i].Separator = separator;

                Assert.IsFalse(series.DataLabels[i].ShowDataLabelsRange);
                Assert.IsTrue(series.DataLabels[i].IsVisible);
                Assert.IsFalse(series.DataLabels[i].IsHidden);
            }
        }
        //ExEnd
        ...
        public void ChartDataPoint()
        {
            ...
            using (IEnumerator<ChartDataPoint> enumerator = chart.Series[0].DataPoints.GetEnumerator())
            {
                while (enumerator.MoveNext())
                {
                    Assert.IsFalse(enumerator.Current.InvertIfNegative);
                }
            }
        ...
        public void Bubble3D()
        {
            ...
            Assert.IsTrue(chart.Series[0].Bubble3D);
            ...
            for (int i = 0; i < 3; i++)
            {
                Assert.IsTrue(series.DataLabels[i].ShowBubbleSize);
            }
        }
        ...
        public void ChartSeriesCollectionModify()
        {
            ...
            Assert.IsFalse(chartData.Any(s => s.Name == "Series 3"));
        ...
        public void AxisBound()
        {
            ...
            Assert.IsTrue(chart.AxisX.Scaling.Minimum.IsAuto);
            ...
            Assert.IsFalse(chart.AxisX.Scaling.Minimum.IsAuto);
            Assert.IsFalse(chart.AxisY.Scaling.Minimum.IsAuto);
            ...
            Assert.IsTrue(chart.AxisY.Scaling.Minimum.IsAuto);
        }
        ...
        public void AxisCross()
        {
            ...
            Assert.IsTrue(axis.AxisBetweenCategories);
        ...
        public void AxisDisplayUnit()
        {
            ...
            CollectionAssert.AreEqual(doc, axis.DisplayUnit.Document);
        ...
        public void TreemapChart()
        {
            ...
            series.DataLabels.NumberFormat.FormatCode = string.Format("#{0}0", thousandSeparator);
        ...
        public void FunnelChart()
        {
            ...
            series.DataLabels.NumberFormat.FormatCode = string.Format("0{0}0%", decimalSeparator);
