...
namespace ApiExamples
{
    ...
    internal class ExFile : ApiExampleBase
    {
        ...
        public void FileFormatToString()
        {
            ...
            Assert.AreEqual(LoadFormat.Docx, FileFormatUtil.ContentTypeToLoadFormat(
                    "application/vnd.openxmlformats-officedocument.wordprocessingml.document"));
            Assert.AreEqual(SaveFormat.Docx, FileFormatUtil.ContentTypeToSaveFormat(
                    "application/vnd.openxmlformats-officedocument.wordprocessingml.document"));
            ...
            foreach (Shape shape in shapes.OfType<Shape>())
            {
                if (shape.HasImage)
                {
                    ...
                    string imageFileName =
                        string.Format("File.ExtractImages.{0}{1}", imageIndex, FileFormatUtil.ImageTypeToExtension(shape.ImageData.ImageType));
