...
namespace ApiExamples
{
    ...
    class ExEditableRange : ApiExampleBase
    {
        ...
        public void Visitor()
        {
            ...
            builder.Writeln(string.Format("This paragraph is inside the first editable range, can only be edited by {0}.", editableRange.SingleUser));
            ...
            builder.Writeln(string.Format("This paragraph is inside the first editable range, can only be edited by {0}.", editableRange.EditorGroup));
            builder.EndEditableRange();
