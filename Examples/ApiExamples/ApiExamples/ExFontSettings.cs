...
namespace ApiExamples
{
    ...
    public class ExFontSettings : ApiExampleBase
    {
        ...
        public void DefaultFontInstance()
        {
            ...
            Assert.IsTrue(FontSettings.DefaultInstance.SubstitutionSettings.DefaultFontSubstitution.Enabled);
        ...
        public void DefaultFontName()
        {
            ...
            Assert.IsFalse(fontSources[0].GetAvailableFonts().Any(f => f.FullFontName == "Arvo"));
            ...
            Assert.IsTrue(fontSources[0].GetAvailableFonts().Any(f => f.FullFontName == "Courier New"));
        ...
        public void UpdatePageLayoutWarnings()
        {
            ...
            Assert.IsTrue(callback.FontWarnings.Count > 0);
            Assert.IsTrue(callback.FontWarnings[0].WarningType == WarningType.FontSubstitution);
            Assert.IsTrue(callback.FontWarnings[0].Description.Contains("has not been found"));
        ...
        public void SubstitutionWarning()
        {
            ...
            Assert.IsTrue(callback.FontSubstitutionWarnings[0].WarningType == WarningType.FontSubstitution);
        ...
        public void EnableFontSubstitution()
        {
            ...
            Assert.AreEqual(WarningSource.Layout, warningCollector[0].Source);
            Assert.AreEqual("Font '28 Days Later' has not been found. Using 'Calibri' font instead. Reason: alternative name from document.", warningCollector[0].Description);

            warningCollector.Clear();

            Assert.AreEqual(0, warningCollector.Count);
        }
        ...
        public void SubstitutionWarningsClosestMatch()
        {
            ...
            Assert.IsTrue(callback[0].Description
                .Equals(
        ...
        public void SubstitutionWarnings()
        {
            ...
            Assert.AreEqual("Font \'Arial\' has not been found. Using \'Arvo\' font instead. Reason: table substitution.", callback[0].Description);
            Assert.AreEqual("Font \'Times New Roman\' has not been found. Using \'M+ 2m\' font instead. Reason: font info substitution.", callback[1].Description);
        }
        ...
        public void GetSubstitutionWithoutSuffixes()
        {
            ...
            Assert.AreEqual("Font 'DINOT-Regular' has not been found. Using 'DINOT' font instead. Reason: font name substitution.", substitutionWarningHandler[0].Description);
        ...
        public void SetFontsFolder(bool recursive)
        {
            ...
            Assert.IsTrue(originalFontSources[0].GetAvailableFonts().Any(f => f.FullFontName == "Arial"));

            // The default font sources are missing the two fonts that we are using in this document.
            Assert.IsFalse(originalFontSources[0].GetAvailableFonts().Any(f => f.FullFontName == "Arvo"));
            Assert.IsFalse(originalFontSources[0].GetAvailableFonts().Any(f => f.FullFontName == "Amethysta"));
            ...
            Assert.IsFalse(newFontSources[0].GetAvailableFonts().Any(f => f.FullFontName == "Arial"));
            Assert.IsTrue(newFontSources[0].GetAvailableFonts().Any(f => f.FullFontName == "Arvo"));

            // The "Amethysta" font is in a subfolder of the font directory.
            if (recursive)
            {
                Assert.AreEqual(30, newFontSources[0].GetAvailableFonts().Count);
                Assert.IsTrue(newFontSources[0].GetAvailableFonts().Any(f => f.FullFontName == "Amethysta"));
            }
            else
            {
                Assert.AreEqual(18, newFontSources[0].GetAvailableFonts().Count);
                Assert.IsFalse(newFontSources[0].GetAvailableFonts().Any(f => f.FullFontName == "Amethysta"));
            }
        ...
        public void SetFontsFolders(bool recursive)
        {
            ...
            // The default font sources are missing the two fonts that we are using in this document.
            Assert.IsFalse(originalFontSources[0].GetAvailableFonts().Any(f => f.FullFontName == "Amethysta"));
            Assert.IsFalse(originalFontSources[0].GetAvailableFonts().Any(f => f.FullFontName == "Junction Light"));
            ...
            if (recursive)
            {
                Assert.AreEqual(11, newFontSources[1].GetAvailableFonts().Count);
                Assert.IsTrue(newFontSources[1].GetAvailableFonts().Any(f => f.FullFontName == "Junction Light"));
            }
            else
            {
        ...
        public void AddFontSource()
        {
            ...
            Assert.IsTrue(updatedFontSources[0].GetAvailableFonts().Any(f => f.FullFontName == "Arial"));
            Assert.IsTrue(updatedFontSources[1].GetAvailableFonts().Any(f => f.FullFontName == "Amethysta"));
            Assert.IsTrue(updatedFontSources[1].GetAvailableFonts().Any(f => f.FullFontName == "Junction Light"));
        ...
        public void SetSpecifyFontFolder()
        {
            ...
            Assert.IsFalse(folderSource.ScanSubfolders);
        }
        ...
        public void TableSubstitution()
        {
            ...
            Assert.IsFalse(fontSources[0].GetAvailableFonts().Any(f => f.FullFontName == "Amethysta"));
        ...
        public void SetSpecifyFontFolders()
        {
            ...
            FolderFontSource folderSource = ((FolderFontSource) doc.FontSettings.GetFontsSources()[0]);
            Assert.AreEqual(FontsDir, folderSource.FolderPath);
            Assert.IsTrue(folderSource.ScanSubfolders);
        ...
        public void AddFontSubstitutes()
        {
            ...
            string[] alternativeFonts = doc.FontSettings.SubstitutionSettings.TableSubstitution.GetSubstitutes("Slab")
                .ToArray();
            CollectionAssert.AreEqual(new string[] {"Times New Roman", "Arial"}, alternativeFonts);

            alternativeFonts = doc.FontSettings.SubstitutionSettings.TableSubstitution.GetSubstitutes("Arvo").ToArray();
            CollectionAssert.AreEqual(new string[] {"Open Sans", "Arial"}, alternativeFonts);
        }
        ...
        public void FontSourceSystem()
        {
            ...
            if (isWindows)
            {
                ...
                string condExpression = SystemFontSource.GetSystemFontFolders().FirstOrDefault();
                if (condExpression != null)
                {
                    actual = condExpression.ToLower();
                }
                Assert.AreEqual(fontsPath.ToLower(), actual);
            }
            ...
            Assert.AreEqual(1, doc.FontSettings.SubstitutionSettings.TableSubstitution.GetSubstitutes("Kreon-Regular").Count());
            Assert.IsTrue(doc.FontSettings.SubstitutionSettings.FontNameSubstitution.Enabled);
            //ExEnd
        }
        ...
        public void DefaultFontSubstitutionRule()
        {
            ...
            Assert.IsTrue(defaultFontSubstitutionRule.Enabled);
        ...
        public void FontConfigSubstitution()
        {
            ...
            if (isWindows)
            {
                Assert.IsFalse(fontConfigSubstitution.Enabled);
                Assert.IsFalse(fontConfigSubstitution.IsFontConfigAvailable());
            }
            ...
            if (isLinuxOrMac)
            {
                Assert.IsTrue(fontConfigSubstitution.Enabled);
                Assert.IsTrue(fontConfigSubstitution.IsFontConfigAvailable());
        ...
        public void FallbackSettingsCustom()
        {
            ...
            for (int i = 0x0021; i < 0x0530; i++)
            {
                ...
                builder.Write(string.Format("{0}", Convert.ToChar(i)));
            }
        ...
        public void TableSubstitutionRule()
        {
            ...
            CollectionAssert.AreEqual(new[] {"Times New Roman"}, tableSubstitutionRule.GetSubstitutes("Times New Roman CE").ToArray());
            ...
            CollectionAssert.AreEqual(new[] {"FreeSerif", "Liberation Serif", "DejaVu Serif"}, tableSubstitutionRule.GetSubstitutes("Times New Roman CE").ToArray());
        ...
        public void TableSubstitutionRuleCustom()
        {
            ...
            CollectionAssert.AreEqual(new[] {"Missing Font", "Kreon"}, tableSubstitutionRule.GetSubstitutes("Arial").ToArray());

            // We can expand this table programmatically. We will add an entry that substitutes "Times New Roman" with "Arvo"
            Assert.IsNull(tableSubstitutionRule.GetSubstitutes("Times New Roman"));
            tableSubstitutionRule.AddSubstitutes("Times New Roman", "Arvo");
            CollectionAssert.AreEqual(new[] {"Arvo"}, tableSubstitutionRule.GetSubstitutes("Times New Roman").ToArray());

            // We can add a secondary fallback substitute for an existing font entry with AddSubstitutes().
            // In case "Arvo" is unavailable, our table will look for "M+ 2m" as a second substitute option.
            tableSubstitutionRule.AddSubstitutes("Times New Roman", "M+ 2m");
            CollectionAssert.AreEqual(new[] {"Arvo", "M+ 2m"}, tableSubstitutionRule.GetSubstitutes("Times New Roman").ToArray());

            // SetSubstitutes() can set a new list of substitute fonts for a font.
            tableSubstitutionRule.SetSubstitutes("Times New Roman", "Squarish Sans CT", "M+ 2m");
            CollectionAssert.AreEqual(new[] {"Squarish Sans CT", "M+ 2m"}, tableSubstitutionRule.GetSubstitutes("Times New Roman").ToArray());
