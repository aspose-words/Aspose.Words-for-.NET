...
{
    public class ExDocumentBuilder : Dirs, IClassFixture<ConfigureTestsFixture>
    {
        [Fact]
        public void WriteAndFont()
        {
            ...
            Assert.Equal("Hello world!", firstRun.GetText().Trim());
            Assert.Equal(16.0d, firstRun.Font.Size);
            Assert.True(firstRun.Font.Bold);
            Assert.Equal("Courier New", firstRun.Font.Name);
            Assert.Equal(Color.Blue.ToArgb(), firstRun.Font.Color.ToArgb());
            Assert.Equal(Underline.Dash, firstRun.Font.Underline);
        }
        ...
        public void HeadersAndFooters()
        {
            ...
            Assert.Equal(3, headersFooters.Count);
            Assert.Equal("Header for the first page", headersFooters[HeaderFooterType.HeaderFirst].GetText().Trim());
            Assert.Equal("Header for even pages", headersFooters[HeaderFooterType.HeaderEven].GetText().Trim());
            Assert.Equal("Header for all other pages", headersFooters[HeaderFooterType.HeaderPrimary].GetText().Trim());
        ...
        public void MergeFields()
        {
            ...
            Assert.Equal(doc.Range.Fields[1].Start, builder.CurrentNode);
            Assert.Equal(doc.Range.Fields[0].End, builder.CurrentNode.PreviousSibling);
            ...
            Assert.Equal("\u0013MERGEFIELD MyMergeField1 \\* MERGEFORMAT\u0014«MyMergeField1»\u0015" +
        ...
        public void InsertHorizontalRule()
        {
            ...
            Assert.Equal(HorizontalRuleAlignment.Center, shape.HorizontalRuleFormat.Alignment);
            Assert.Equal(70, shape.HorizontalRuleFormat.WidthPercent);
            Assert.Equal(3, shape.HorizontalRuleFormat.Height);
            Assert.Equal(Color.Blue.ToArgb(), shape.HorizontalRuleFormat.Color.ToArgb());
        }
        ...
        public void InsertHyperlink()
        {
            ...
            Assert.Equal(Color.Blue.ToArgb(), fieldContents.Font.Color.ToArgb());
            Assert.Equal(Underline.Single, fieldContents.Font.Underline);
            Assert.Equal("HYPERLINK \"https://www.google.com\"", fieldContents.GetText().Trim());
        }
        ...
        public void PushPopFont()
        {
            ...
            Assert.Equal(Color.Blue.ToArgb(), builder.Font.Color.ToArgb());
            Assert.Equal(Underline.Single, builder.Font.Underline);

            // Restore the font formatting that we saved earlier and remove the element from the stack.
            builder.PopFont();

            Assert.Equal(Color.Empty.ToArgb(), builder.Font.Color.ToArgb());
            Assert.Equal(Underline.None, builder.Font.Underline);
            ...
            Assert.Equal("To visit Google, hold Ctrl and click", runs[0].GetText().Trim());
            Assert.Equal(". We hope you enjoyed the example.", runs[3].GetText().Trim());
            Assert.Equal(runs[0].Font.Color, runs[3].Font.Color);
            Assert.Equal(runs[0].Font.Underline, runs[3].Font.Underline);

            Assert.Equal("here", runs[2].GetText().Trim());
            Assert.Equal(Color.Blue.ToArgb(), runs[2].Font.Color.ToArgb());
            Assert.Equal(Underline.Single, runs[2].Font.Underline);
            Assert.NotEqual(runs[0].Font.Color, runs[2].Font.Color);
            Assert.NotEqual(runs[0].Font.Underline, runs[2].Font.Underline);
        }
        ...
        public void InsertWatermarkNetStandard2()
        {
            ...
            Assert.Equal(WrapType.None, outShape.WrapType);
            Assert.True(outShape.BehindText);
            Assert.Equal(RelativeHorizontalPosition.Page, outShape.RelativeHorizontalPosition);
            Assert.Equal(RelativeVerticalPosition.Page, outShape.RelativeVerticalPosition);
            Assert.Equal((doc.FirstSection.PageSetup.PageWidth - outShape.Width) / 2, outShape.Left);
            Assert.Equal((doc.FirstSection.PageSetup.PageHeight - outShape.Height) / 2, outShape.Top);
        }
        ...
        public void InsertHtml()
        {
            ...
            Assert.Equal("Paragraph right", paragraphs[0].GetText().Trim());
            Assert.Equal(ParagraphAlignment.Right, paragraphs[0].ParagraphFormat.Alignment);

            Assert.Equal("Implicit paragraph left", paragraphs[1].GetText().Trim());
            Assert.Equal(ParagraphAlignment.Left, paragraphs[1].ParagraphFormat.Alignment);
            Assert.True(paragraphs[1].Runs[0].Font.Bold);

            Assert.Equal("Div center", paragraphs[2].GetText().Trim());
            Assert.Equal(ParagraphAlignment.Center, paragraphs[2].ParagraphFormat.Alignment);

            Assert.Equal("Heading 1 left.", paragraphs[3].GetText().Trim());
            Assert.Equal("Heading 1", paragraphs[3].ParagraphFormat.Style.Name);
        ...
        public void InsertHtmlWithFormatting(bool useBuilderFormatting)
        {
            ...
            Assert.Equal("Paragraph 1.", paragraphs[0].GetText().Trim());
            Assert.Equal(ParagraphAlignment.Right, paragraphs[0].ParagraphFormat.Alignment);
            ...
            Assert.Equal("Paragraph 2.", paragraphs[1].GetText().Trim());
            Assert.Equal(useBuilderFormatting ? ParagraphAlignment.Distributed : ParagraphAlignment.Left,
        ...
        public void MathMl()
        {
            ...
            Assert.True(DocumentHelper.CompareDocs(GoldsDir + "DocumentBuilder.MathML Gold.docx", ArtifactsDir + "DocumentBuilder.MathML.docx"));
        }
        ...
        public void InsertTextAndBookmark()
        {
            ...
            Assert.Equal(1, doc.Range.Bookmarks.Count);
            Assert.Equal("MyBookmark", doc.Range.Bookmarks[0].Name);
            Assert.Equal("Hello world!", doc.Range.Bookmarks[0].Text.Trim());
            //ExEnd
        }
        ...
        public void CreateColumnBookmark()
        {
            ...
            Assert.Throws<InvalidOperationException>(() => builder.EndColumnBookmark("BadEndBookmark")); //ExSkip
        ...
        public void CreateForm()
        {
            ...
            Assert.Equal("My text input", formField.Name);
            Assert.Equal(TextFormFieldType.Regular, formField.TextInputType);
            Assert.Equal("Enter your name here", formField.Result);

            formField = doc.Range.FormFields[1];

            Assert.Equal("My combo box", formField.Name);
            Assert.Equal(TextFormFieldType.Regular, formField.TextInputType);
            Assert.Equal("-- Select your favorite footwear --", formField.Result);
            Assert.Equal(0, formField.DropDownSelectedIndex);
            Assert.Equal(new[]
            {
                "-- Select your favorite footwear --", "Sneakers", "Oxfords", "Flip-flops", "Other"
        ...
        public void InsertCheckBox()
        {
            ...
            Assert.Equal("CheckBox_OnlyChecked", doc.Range.FormFields[2].Name);
            ...
            Assert.Equal(string.Empty, formFields[0].Name);
            Assert.False(formFields[0].Checked);
            Assert.False(formFields[0].Default);
            Assert.Equal(10, formFields[0].CheckBoxSize);

            Assert.Equal("CheckBox_Default", formFields[1].Name);
            Assert.True(formFields[1].Checked);
            Assert.True(formFields[1].Default);
            Assert.Equal(50, formFields[1].CheckBoxSize);

            Assert.Equal("CheckBox_OnlyChecked", formFields[2].Name);
            Assert.True(formFields[2].Checked);
            Assert.True(formFields[2].Default);
            Assert.Equal(100, formFields[2].CheckBoxSize);
        }
        ...
        public void WorkingWithNodes()
        {
            ...
            NodeCollection firstParagraphNodes = doc.FirstSection.Body.FirstParagraph.GetChildNodes(NodeType.Paragraph, false);

            Assert.Equal(NodeType.BookmarkStart, firstParagraphNodes[0].NodeType);
            Assert.Equal(NodeType.Run, firstParagraphNodes[1].NodeType);
            Assert.Equal("Bookmark contents.", firstParagraphNodes[1].GetText().Trim());
            Assert.Equal(NodeType.BookmarkEnd, firstParagraphNodes[2].NodeType);
            ...
            Assert.Equal(firstParagraphNodes[1], builder.CurrentNode);

            // We can also move the cursor to an individual node like this.
            builder.MoveTo(doc.FirstSection.Body.FirstParagraph.GetChildNodes(NodeType.Any, false)[0]);

            Assert.Equal(NodeType.BookmarkStart, builder.CurrentNode.NodeType);
            Assert.Equal(doc.FirstSection.Body.FirstParagraph, builder.CurrentParagraph);
            Assert.True(builder.IsAtStartOfParagraph);

            // We can use specific methods to move to the start/end of a document.
            builder.MoveToDocumentEnd();

            Assert.True(builder.IsAtEndOfParagraph);
        ...
        public void FillMergeFields()
        {
            ...
            Assert.Equal("John Doe", paragraphs[0].Runs[0].GetText().Trim());

            Assert.True(paragraphs[1].Runs[0].Font.Italic);
            Assert.Equal("Jane Doe", paragraphs[1].Runs[0].GetText().Trim());

            Assert.True(paragraphs[2].Runs[0].Font.Italic);
            Assert.Equal("John Bloggs", paragraphs[2].Runs[0].GetText().Trim());
        ...
        public void InsertToc()
        {
            ...
            Assert.Equal("1-3", tableOfContents.HeadingLevelRange);
            Assert.True(tableOfContents.InsertHyperlinks);
            Assert.True(tableOfContents.HideInWebLayout);
            Assert.True(tableOfContents.UseParagraphOutlineLevel);
        }
        ...
        public void InsertTable()
        {
            ...
            Assert.Equal("Row 1, Col 1\a", table.Rows[0].Cells[0].GetText().Trim());
            Assert.Equal("Row 1, Col 2\a", table.Rows[0].Cells[1].GetText().Trim());
            Assert.Equal(HeightRule.Exactly, table.Rows[0].RowFormat.HeightRule);
            Assert.Equal(50.0d, table.Rows[0].RowFormat.Height);
            Assert.Equal(LineStyle.Engrave3D, table.Rows[0].RowFormat.Borders.LineStyle);
            Assert.Equal(Color.Orange.ToArgb(), table.Rows[0].RowFormat.Borders.Color.ToArgb());

            foreach (Cell c in table.Rows[0].Cells)
            {
                Assert.Equal(150, c.CellFormat.Width);
                Assert.Equal(CellVerticalAlignment.Center, c.CellFormat.VerticalAlignment);
                Assert.Equal(Color.GreenYellow.ToArgb(), c.CellFormat.Shading.BackgroundPatternColor.ToArgb());
                Assert.False(c.CellFormat.WrapText);
                Assert.True(c.CellFormat.FitText);

                Assert.Equal(ParagraphAlignment.Center, c.FirstParagraph.ParagraphFormat.Alignment);
            }

            Assert.Equal("Row 2, Col 1\a", table.Rows[1].Cells[0].GetText().Trim());
            Assert.Equal("Row 2, Col 2\a", table.Rows[1].Cells[1].GetText().Trim());
            ...
            foreach (Cell c in table.Rows[1].Cells)
            {
                Assert.Equal(150, c.CellFormat.Width);
                Assert.Equal(CellVerticalAlignment.Center, c.CellFormat.VerticalAlignment);
                Assert.Equal(Color.Empty.ToArgb(), c.CellFormat.Shading.BackgroundPatternColor.ToArgb());
                Assert.False(c.CellFormat.WrapText);
                Assert.True(c.CellFormat.FitText);
            ...
            Assert.Equal(150, table.Rows[2].RowFormat.Height);

            Assert.Equal("Row 3, Col 1\a", table.Rows[2].Cells[0].GetText().Trim());
            Assert.Equal(TextOrientation.Upward, table.Rows[2].Cells[0].CellFormat.Orientation);
            Assert.Equal(ParagraphAlignment.Center, table.Rows[2].Cells[0].FirstParagraph.ParagraphFormat.Alignment);

            Assert.Equal("Row 3, Col 2\a", table.Rows[2].Cells[1].GetText().Trim());
            Assert.Equal(TextOrientation.Downward, table.Rows[2].Cells[1].CellFormat.Orientation);
            Assert.Equal(ParagraphAlignment.Center, table.Rows[2].Cells[1].FirstParagraph.ParagraphFormat.Alignment);
        }
        ...
        public void InsertTableWithStyle()
        {
            ...
            Assert.Equal("Medium Shading 1 Accent 1", table.Style.Name);
            Assert.Equal(TableStyleOptions.FirstColumn | TableStyleOptions.RowBands | TableStyleOptions.FirstRow,
                table.StyleOptions);
            Assert.Equal(189, table.FirstRow.FirstCell.CellFormat.Shading.BackgroundPatternColor.B);
            Assert.Equal(Color.White.ToArgb(), table.FirstRow.FirstCell.FirstParagraph.Runs[0].Font.Color.ToArgb());
            Assert.NotEqual(Color.LightBlue.ToArgb(),
                table.LastRow.FirstCell.CellFormat.Shading.BackgroundPatternColor.B);
            Assert.Equal(Color.Empty.ToArgb(), table.LastRow.FirstCell.FirstParagraph.Runs[0].Font.Color.ToArgb());
        }
        ...
        public void InsertTableSetHeadingRow()
        {
            ...
            for (int i = 0; i < table.Rows.Count; i++)
                Assert.Equal(i < 2, table.Rows[i].RowFormat.HeadingFormat);
        }
        ...
        public void InsertTableWithPreferredWidth()
        {
            ...
            Assert.Equal(PreferredWidthType.Percent, table.PreferredWidth.Type);
            Assert.Equal(50, table.PreferredWidth.Value);
        }
        ...
        public void InsertCellsWithPreferredWidths()
        {
            ...
            Assert.NotEqual(table.FirstRow.Cells[1].CellFormat.PreferredWidth.GetHashCode(),
            ...
            Assert.Equal(100.0d, PreferredWidth.FromPercent(100).Value);
            Assert.Equal(100.0d, PreferredWidth.FromPoints(100).Value);

            doc = new Document(ArtifactsDir + "DocumentBuilder.InsertCellsWithPreferredWidths.docx");
            table = doc.FirstSection.Body.Tables[0];
            
            Assert.Equal(PreferredWidthType.Points, table.FirstRow.Cells[0].CellFormat.PreferredWidth.Type);
            Assert.Equal(40.0d, table.FirstRow.Cells[0].CellFormat.PreferredWidth.Value);
            Assert.Equal("Cell with a width of 800.\r\a", table.FirstRow.Cells[0].GetText().Trim());

            Assert.Equal(PreferredWidthType.Percent, table.FirstRow.Cells[1].CellFormat.PreferredWidth.Type);
            Assert.Equal(20.0d, table.FirstRow.Cells[1].CellFormat.PreferredWidth.Value);
            Assert.Equal("Cell with a width of 20%.\r\a", table.FirstRow.Cells[1].GetText().Trim());

            Assert.Equal(PreferredWidthType.Auto, table.FirstRow.Cells[2].CellFormat.PreferredWidth.Type);
            Assert.Equal(0.0d, table.FirstRow.Cells[2].CellFormat.PreferredWidth.Value);
            Assert.Equal("Automatically sized cell.\r\a", table.FirstRow.Cells[2].GetText().Trim());
        }
        ...
        public void InsertTableFromHtml()
        {
            ...
            Assert.Equal(1, doc.GetChildNodes(NodeType.Table, true).Count);
            Assert.Equal(2, doc.GetChildNodes(NodeType.Row, true).Count);
            Assert.Equal(4, doc.GetChildNodes(NodeType.Cell, true).Count);
        }
        ...
        public void InsertNestedTable()
        {
            ...
            Assert.Equal(2, doc.GetChildNodes(NodeType.Table, true).Count);
            Assert.Equal(4, doc.GetChildNodes(NodeType.Cell, true).Count);
            Assert.Equal(1, cell.Tables[0].Count);
            Assert.Equal(2, cell.Tables[0].FirstRow.Cells.Count);
        }
        ...
        public void CreateTable()
        {
            ...
            Assert.Equal(4, table.GetChildNodes(NodeType.Cell, true).Count);

            Assert.Equal("Row 1, Cell 1.\a", table.Rows[0].Cells[0].GetText().Trim());
            Assert.Equal("Row 1, Cell 2.\a", table.Rows[0].Cells[1].GetText().Trim());
            Assert.Equal("Row 2, Cell 1.\a", table.Rows[1].Cells[0].GetText().Trim());
            Assert.Equal("Row 2, Cell 2.\a", table.Rows[1].Cells[1].GetText().Trim());
        }
        ...
        public void BuildFormattedTable()
        {
            ...
            Assert.Equal(20.0d, table.LeftIndent);

            Assert.Equal(HeightRule.AtLeast, table.Rows[0].RowFormat.HeightRule);
            Assert.Equal(40.0d, table.Rows[0].RowFormat.Height);
            ...
            foreach (Cell c in doc.GetChildNodes(NodeType.Cell, true))
            {
                ...
                {
                    Assert.Equal("Arial", r.Font.Name);

                    if (c.ParentRow == table.FirstRow)
                    {
                        Assert.Equal(16, r.Font.Size);
                        Assert.True(r.Font.Bold);
                    }
                    else
                    {
                        Assert.Equal(12, r.Font.Size);
        ...
        public void TableBordersAndShading()
        {
            ...
            {
                Assert.Equal(0.5d, c.CellFormat.Borders.Top.LineWidth);
                Assert.Equal(0.5d, c.CellFormat.Borders.Bottom.LineWidth);
                Assert.Equal(0.5d, c.CellFormat.Borders.Left.LineWidth);
                Assert.Equal(0.5d, c.CellFormat.Borders.Right.LineWidth);

                Assert.Equal(Color.Empty.ToArgb(), c.CellFormat.Borders.Left.Color.ToArgb());
                Assert.Equal(LineStyle.Single, c.CellFormat.Borders.Left.LineStyle);
            }

            Assert.Equal(Color.LightSkyBlue.ToArgb(),
                table.FirstRow.FirstCell.CellFormat.Shading.BackgroundPatternColor.ToArgb());
            Assert.Equal(Color.Orange.ToArgb(),
                table.FirstRow.Cells[1].CellFormat.Shading.BackgroundPatternColor.ToArgb());

            foreach (Cell c in table.LastRow)
            {
                Assert.Equal(4.0d, c.CellFormat.Borders.Top.LineWidth);
                Assert.Equal(4.0d, c.CellFormat.Borders.Bottom.LineWidth);
                Assert.Equal(4.0d, c.CellFormat.Borders.Left.LineWidth);
                Assert.Equal(4.0d, c.CellFormat.Borders.Right.LineWidth);
        ...
        public void SetPreferredTypeConvertUtil()
        {
            ...
            Assert.Equal(216.0d, table.FirstRow.FirstCell.CellFormat.PreferredWidth.Value);
            //ExEnd
        }
        ...
        public void InsertHyperlinkToLocalBookmark()
        {
            ...
            Assert.Equal("Bookmark1", hyperlink.SubAddress);
            Assert.Equal("Hyperlink Tip", hyperlink.ScreenTip);
            Assert.Contains(doc.Range.Bookmarks, b => b.Name == "Bookmark1");
        }
        ...
        public void CursorPosition()
        {
            ...
            Assert.Equal("Hello world!", builder.CurrentParagraph.GetText().Trim());

            // Move to the beginning of the document and place the cursor at an existing node.
            builder.MoveToDocumentStart();          
            Assert.Equal(NodeType.Run, builder.CurrentNode.NodeType);
        }
        ...
        public void MoveTo()
        {
            ...
            Assert.Equal(doc.FirstSection.Body.LastParagraph, builder.CurrentParagraph); //ExSkip
            builder.MoveTo(doc.FirstSection.Body.FirstParagraph.Runs[0]);
            Assert.Equal(doc.FirstSection.Body.FirstParagraph, builder.CurrentParagraph); //ExSkip
        ...
        public void MoveToParagraph()
        {
            ...
            Assert.Equal(22, paragraphs.Count);
            ...
            Assert.Equal(0, paragraphs.IndexOf(builder.CurrentParagraph));

            // Move that cursor to a different paragraph will place that cursor in front of that paragraph.
            builder.MoveToParagraph(2, 0);
            Assert.Equal(2, paragraphs.IndexOf(builder.CurrentParagraph)); //ExSkip

            // Any new content that we add will be inserted at that point.
            builder.Writeln("This is a new third paragraph. ");
            //ExEnd

            Assert.Equal(3, paragraphs.IndexOf(builder.CurrentParagraph));

            doc = DocumentHelper.SaveOpen(doc);

            Assert.Equal("This is a new third paragraph.", doc.FirstSection.Body.Paragraphs[2].GetText().Trim());
        }
        ...
        public void MoveToCell()
        {
            ...
            Assert.Equal("Column 2, cell 2.\a", table.Rows[1].Cells[1].GetText().Trim());
        }
        ...
        public void MoveToBookmark()
        {
            ...
            Assert.Equal("Hello world! ", doc.Range.Bookmarks["MyBookmark"].Text);
            Assert.Equal("1. Hello world!", doc.GetText().Trim());

            // 2 -  Inside the bookmark, right after the BookmarkStart node:
            Assert.True(builder.MoveToBookmark("MyBookmark", true, true));
            builder.Write("2. ");

            Assert.Equal("2. Hello world! ", doc.Range.Bookmarks["MyBookmark"].Text);
            Assert.Equal("1. 2. Hello world!", doc.GetText().Trim());

            // 2 -  Inside the bookmark, right in front of the BookmarkEnd node:
            Assert.True(builder.MoveToBookmark("MyBookmark", false, false));
            builder.Write("3. ");

            Assert.Equal("2. Hello world! 3. ", doc.Range.Bookmarks["MyBookmark"].Text);
            Assert.Equal("1. 2. Hello world! 3.", doc.GetText().Trim());
            ...
            Assert.Equal("2. Hello world! 3. ", doc.Range.Bookmarks["MyBookmark"].Text);
            Assert.Equal("1. 2. Hello world! 3. 4.", doc.GetText().Trim());
            //ExEnd
        }
        ...
        public void BuildTable()
        {
            ...
            Assert.Equal(CellVerticalAlignment.Center, table.Rows[0].Cells[0].CellFormat.VerticalAlignment);
            Assert.Equal(CellVerticalAlignment.Center, table.Rows[0].Cells[1].CellFormat.VerticalAlignment);
            ...
            Assert.Equal(0, table.Rows[0].RowFormat.Height);
            Assert.Equal(HeightRule.Auto, table.Rows[0].RowFormat.HeightRule);
            Assert.Equal(100, table.Rows[1].RowFormat.Height);
            Assert.Equal(HeightRule.Exactly, table.Rows[1].RowFormat.HeightRule);
            Assert.Equal(TextOrientation.Upward, table.Rows[1].Cells[0].CellFormat.Orientation);
            Assert.Equal(TextOrientation.Downward, table.Rows[1].Cells[1].CellFormat.Orientation);
        ...
        public void TableCellVerticalRotatedFarEastTextOrientation()
        {
            ...
            Assert.Equal(TextOrientation.VerticalRotatedFarEast, cell.CellFormat.Orientation);
        ...
        public void InsertFloatingImage()
        {
            ...
            Assert.Equal(100.0d, image.Left);
            Assert.Equal(0.0d, image.Top);
            Assert.Equal(200.0d, image.Width);
            Assert.Equal(200.0d, image.Height);
            Assert.Equal(WrapType.Square, image.WrapType);
            Assert.Equal(RelativeHorizontalPosition.Margin, image.RelativeHorizontalPosition);
            Assert.Equal(RelativeVerticalPosition.Margin, image.RelativeVerticalPosition);

            image = (Shape)doc.GetChild(NodeType.Shape, 1, true);

            Assert.Equal(100.0d, image.Left);
            Assert.Equal(250.0d, image.Top);
            Assert.Equal(200.0d, image.Width);
            Assert.Equal(200.0d, image.Height);
            Assert.Equal(WrapType.Square, image.WrapType);
            Assert.Equal(RelativeHorizontalPosition.Margin, image.RelativeHorizontalPosition);
        ...
        public void InsertImageOriginalSize()
        {
            ...
            Assert.Equal(300.0d, imageShape.Width);
            Assert.Equal(300.0d, imageShape.Height);
            ...
            Assert.Equal(0.0d, imageShape.Left);
            Assert.Equal(0.0d, imageShape.Top);
            Assert.Equal(300.0d, imageShape.Width);
            Assert.Equal(300.0d, imageShape.Height);
            Assert.Equal(WrapType.Square, imageShape.WrapType);
            Assert.Equal(RelativeHorizontalPosition.Margin, imageShape.RelativeHorizontalPosition);
            Assert.Equal(RelativeVerticalPosition.Margin, imageShape.RelativeVerticalPosition);
        }
        ...
        public void InsertTextInput()
        {
            ...
            Assert.Equal("TextInput", formField.Name);
            Assert.Equal(0, formField.MaxLength);
            Assert.Equal("Enter your text here", formField.Result);
            Assert.Equal(FieldType.FieldFormTextInput, formField.Type);
            Assert.Equal("", formField.TextInputFormat);
            Assert.Equal(TextFormFieldType.Regular, formField.TextInputType);
        }
        ...
        public void InsertComboBox()
        {
            ...
            Assert.True(formField.Enabled);
            Assert.Equal("DropDown", formField.Name);
            Assert.Equal(0, formField.DropDownSelectedIndex);
            Assert.Equal(items, formField.DropDownItems);
            Assert.Equal(FieldType.FieldFormDropDown, formField.Type);
        }
        ...
        public void SignatureLineProviderId()
        {
            ...
            Assert.Equal("vderyushev", signatureLine.Signer);
            Assert.Equal("QA", signatureLine.SignerTitle);
            Assert.Equal("vderyushev@aspose.com", signatureLine.Email);
            Assert.True(signatureLine.ShowDate);
            Assert.False(signatureLine.DefaultInstructions);
            Assert.Equal("Please sign here.", signatureLine.Instructions);
            ...
            Assert.Equal("Document was signed by vderyushev", signatures[0].Comments);
            Assert.Equal(DateTime.Today, signatures[0].SignTime.Date);
            Assert.Equal("CN=Morzal.Me", signatures[0].IssuerName);
            Assert.Equal(DigitalSignatureType.XmlDsig, signatures[0].SignatureType);
        ...
        public void SignatureLineInline()
        {
            ...
            Assert.Equal("John Doe", signatureLine.Signer);
            Assert.Equal("Manager", signatureLine.SignerTitle);
            Assert.Equal("johndoe@aspose.com", signatureLine.Email);
            Assert.True(signatureLine.ShowDate);
            Assert.False(signatureLine.DefaultInstructions);
            Assert.Equal("Please sign here.", signatureLine.Instructions);
            Assert.True(signatureLine.AllowComments);
        ...
        public void SetParagraphFormatting()
        {
            ...
            {
                Assert.Equal(ParagraphAlignment.Center, paragraph.ParagraphFormat.Alignment);
                Assert.Equal(100.0d, paragraph.ParagraphFormat.LeftIndent);
                Assert.Equal(50.0d, paragraph.ParagraphFormat.RightIndent);
                Assert.Equal(25.0d, paragraph.ParagraphFormat.SpaceAfter);
            }
        }
        ...
        public void SetCellFormatting()
        {
            ...
            Assert.Equal(0.0d, table.FirstRow.Cells[0].CellFormat.Width);
            Assert.Equal(5.4d, table.FirstRow.Cells[0].CellFormat.LeftPadding);
            Assert.Equal(5.4d, table.FirstRow.Cells[0].CellFormat.RightPadding);
            Assert.Equal(0.0d, table.FirstRow.Cells[0].CellFormat.TopPadding);
            Assert.Equal(0.0d, table.FirstRow.Cells[0].CellFormat.BottomPadding);

            Assert.Equal(250.0d, table.FirstRow.Cells[1].CellFormat.Width);
            Assert.Equal(30.0d, table.FirstRow.Cells[1].CellFormat.LeftPadding);
            Assert.Equal(30.0d, table.FirstRow.Cells[1].CellFormat.RightPadding);
            Assert.Equal(30.0d, table.FirstRow.Cells[1].CellFormat.TopPadding);
            Assert.Equal(30.0d, table.FirstRow.Cells[1].CellFormat.BottomPadding);
            ...
            Assert.Equal(159.3d, table.FirstRow.Cells[0].CellFormat.Width);
            Assert.Equal(5.4d, table.FirstRow.Cells[0].CellFormat.LeftPadding);
            Assert.Equal(5.4d, table.FirstRow.Cells[0].CellFormat.RightPadding);
            Assert.Equal(0.0d, table.FirstRow.Cells[0].CellFormat.TopPadding);
            Assert.Equal(0.0d, table.FirstRow.Cells[0].CellFormat.BottomPadding);

            Assert.Equal(310.0d, table.FirstRow.Cells[1].CellFormat.Width);
            Assert.Equal(30.0d, table.FirstRow.Cells[1].CellFormat.LeftPadding);
            Assert.Equal(30.0d, table.FirstRow.Cells[1].CellFormat.RightPadding);
            Assert.Equal(30.0d, table.FirstRow.Cells[1].CellFormat.TopPadding);
            Assert.Equal(30.0d, table.FirstRow.Cells[1].CellFormat.BottomPadding);
        ...
        public void SetRowFormatting()
        {
            ...
            Assert.Equal(0.0d, table.Rows[0].RowFormat.Height);
            Assert.Equal(HeightRule.Auto, table.Rows[0].RowFormat.HeightRule);

            Assert.Equal(100.0d, table.Rows[1].RowFormat.Height);
            Assert.Equal(HeightRule.Exactly, table.Rows[1].RowFormat.HeightRule);
        ...
        public void ApplyBordersAndShading()
        {
            ...
            Assert.Equal(20.0d, borders.DistanceFromText);
            Assert.Equal(LineStyle.Double, borders[BorderType.Left].LineStyle);
            Assert.Equal(LineStyle.Double, borders[BorderType.Right].LineStyle);
            Assert.Equal(LineStyle.Double, borders[BorderType.Top].LineStyle);
            Assert.Equal(LineStyle.Double, borders[BorderType.Bottom].LineStyle);

            Assert.Equal(TextureIndex.TextureDiagonalCross, shading.Texture);
            Assert.Equal(Color.LightCoral.ToArgb(), shading.BackgroundPatternColor.ToArgb());
            Assert.Equal(Color.LightSalmon.ToArgb(), shading.ForegroundPatternColor.ToArgb());
        }
        ...
        public void DeleteRow()
        {
            ...
            Assert.Equal("Row 2, cell 1.\aRow 2, cell 2.\a\a", table.GetText().Trim());
            //ExEnd
        }
        ...
        public void IgnoreTextBoxes(bool ignoreTextBoxes)
        {
            ...
            if (ignoreTextBoxes)
            {
                Assert.Equal(12.0d, importedTextBox.FirstParagraph.Runs[0].Font.Size);
                Assert.Equal("Times New Roman", importedTextBox.FirstParagraph.Runs[0].Font.Name);
            }
            else
            {
                Assert.Equal(24.0d, importedTextBox.FirstParagraph.Runs[0].Font.Size);
                Assert.Equal("Courier New", importedTextBox.FirstParagraph.Runs[0].Font.Name);
            }
        ...
        public void MoveToField(bool moveCursorToAfterTheField)
        {
            ...
            if (moveCursorToAfterTheField)
            {
                ...
                Assert.Equal("\u0013 AUTHOR \"John Doe\" \u0014John Doe\u0015 Text immediately after the field.", 
                    doc.GetText().Trim());
            }
            else
            {
                Assert.Equal(field.Start, builder.CurrentNode);
                builder.Write("Text immediately before the field. ");

                Assert.Equal("Text immediately before the field. \u0013 AUTHOR \"John Doe\" \u0014John Doe\u0015", 
                    doc.GetText().Trim());
            }
            //ExEnd
        }
        ...
        public void InsertPieChart()
        {
            ...
            Assert.Equal(225.0d, ConvertUtil.PixelToPoint(300)); //ExSkip
            chart.Series.Clear();
            ...
            Assert.Equal("Chart Title", chartShape.Chart.Title.Text);
            Assert.Equal(225.0d, chartShape.Width);
            Assert.Equal(225.0d, chartShape.Height);
        }
        ...
        public void InsertChartRelativePosition()
        {
            ...
            Assert.Equal(100.0d, chartShape.Top);
            Assert.Equal(100.0d, chartShape.Left);
            Assert.Equal(200.0d, chartShape.Width);
            Assert.Equal(100.0d, chartShape.Height);
            Assert.Equal(WrapType.Square, chartShape.WrapType);
            Assert.Equal(RelativeHorizontalPosition.Margin, chartShape.RelativeHorizontalPosition);
            Assert.Equal(RelativeVerticalPosition.Margin, chartShape.RelativeVerticalPosition);
        }
        ...
        public void InsertField()
        {
            ...
            Assert.Equal("DATE \\@ \"dddd, MMMM dd, yyyy\"", field.GetFieldCode());
            //ExEnd			
        }
        ...
        public void InsertFieldAndUpdate(bool updateInsertedFieldsImmediately)
        {
            ...
            Assert.Equal(" AUTHOR ", doc.Range.Fields[0].GetFieldCode());
            Assert.Equal(" PAGE ", doc.Range.Fields[1].GetFieldCode());

            if (updateInsertedFieldsImmediately)
            {
                Assert.Equal("John Doe", doc.Range.Fields[0].Result);
                Assert.Equal("1", doc.Range.Fields[1].Result);
            }
            else
            {
                Assert.Equal(string.Empty, doc.Range.Fields[0].Result);
                Assert.Equal(string.Empty, doc.Range.Fields[1].Result);
            ...
            Assert.Equal("This document was written by \u0013 AUTHOR \u0014John Doe\u0015" +
        ...
        public void FieldResultFormatting()
        {
            ...
            Assert.Equal("$5", doc.Range.Fields[0].Result);
            Assert.Equal(1, formatter.CountFormatInvocations(FieldResultFormatter.FormatInvocationType.Numeric));

            // 2 -  Date/time:
            builder.InsertField("DATE \\@ \"d MMMM yyyy\"");

            Assert.StartsWith("Date: ", doc.Range.Fields[1].Result);
            Assert.Equal(1, formatter.CountFormatInvocations(FieldResultFormatter.FormatInvocationType.DateTime));

            // 3 -  General:
            builder.InsertField("QUOTE \"2\" \\* Ordinal");

            Assert.Equal("Item # 2:", doc.Range.Fields[2].Result);
            Assert.Equal(1, formatter.CountFormatInvocations(FieldResultFormatter.FormatInvocationType.General));
        ...
        public void InsertUnderline()
        {
            ...
            Assert.Equal("Large, blue, and underlined text.", firstRun.GetText().Trim());
            Assert.Equal(Underline.Dash, firstRun.Font.Underline);
            Assert.Equal(Color.Blue.ToArgb(), firstRun.Font.Color.ToArgb());
            Assert.Equal(32.0d, firstRun.Font.Size);
        }
        ...
        public void CurrentStory()
        {
            ...
            Assert.Equal(builder.CurrentStory, doc.FirstSection.Body);
            Assert.Equal(builder.CurrentStory, builder.CurrentParagraph.ParentNode);
            Assert.Equal(StoryType.MainText, builder.CurrentStory.StoryType);
            ...
            Assert.True(builder.CurrentStory.Tables.Contains(table));
            //ExEnd

            doc = DocumentHelper.SaveOpen(doc);
            Assert.Equal(1, doc.FirstSection.Body.Tables.Count);
            Assert.Equal("Row 1, cell 1\aRow 1, cell 2\a\a\rText added to current Story.", doc.FirstSection.Body.GetText().Trim());
        }        
        ...
        public void InsertStyleSeparator()
        {
            ...
            Assert.Equal(2, doc.FirstSection.Body.Paragraphs.Count);
            Assert.Equal("Heading 1", doc.FirstSection.Body.Paragraphs[0].ParagraphFormat.Style.Name);
            Assert.Equal("MyParaStyle", doc.FirstSection.Body.Paragraphs[1].ParagraphFormat.Style.Name);
            ...
            Assert.Equal(2, doc.FirstSection.Body.Paragraphs.Count);
            Assert.Equal("This text is in a Heading style. \r This text is in a custom style.",
                doc.GetText().Trim());
            Assert.Equal("Heading 1", doc.FirstSection.Body.Paragraphs[0].ParagraphFormat.Style.Name);
            Assert.Equal("MyParaStyle", doc.FirstSection.Body.Paragraphs[1].ParagraphFormat.Style.Name);
            Assert.Equal(" ", doc.FirstSection.Body.Paragraphs[1].Runs[0].GetText());
        }        
        ...
        public void SmartStyleBehavior()
        {
            ...
            Assert.Equal(Color.Blue.ToArgb(), dstDoc.Styles["MyStyle"].Font.Color.ToArgb());
            Assert.Equal("MyStyle", dstDoc.FirstSection.Body.Paragraphs[0].ParagraphFormat.Style.Name);

            Assert.Equal("Normal", dstDoc.FirstSection.Body.Paragraphs[1].ParagraphFormat.Style.Name);
            Assert.Equal(14, dstDoc.FirstSection.Body.Paragraphs[1].Runs[0].Font.Size);
            Assert.Equal("Courier New", dstDoc.FirstSection.Body.Paragraphs[1].Runs[0].Font.Name);
            Assert.Equal(Color.Red.ToArgb(), dstDoc.FirstSection.Body.Paragraphs[1].Runs[0].Font.Color.ToArgb());
        }
        ...
        public void EmphasesWarningSourceMarkdown()
        {
            ...
            foreach (WarningInfo warningInfo in warnings)
            {
                if (warningInfo.Source == WarningSource.Markdown)
                    Assert.Equal("The (*, 0:11) cannot be properly written into Markdown.", warningInfo.Description);
            }
        }
        ...
        public void InsertOnlineVideo()
        {
            ...
            Assert.Equal(320.0d, shape.Width);
            Assert.Equal(180.0d, shape.Height);
            Assert.Equal(0.0d, shape.Left);
            Assert.Equal(0.0d, shape.Top);
            Assert.Equal(WrapType.Square, shape.WrapType);
            Assert.Equal(RelativeVerticalPosition.TopMargin, shape.RelativeVerticalPosition);
            Assert.Equal(RelativeHorizontalPosition.LeftMargin, shape.RelativeHorizontalPosition);

            Assert.Equal("https://vimeo.com/52477838", shape.HRef);
        }
        ...
        public void InsertOnlineVideoCustomThumbnail()
        {
            ...
            Assert.Equal(400.0d, shape.Width);
            Assert.Equal(400.0d, shape.Height);
            Assert.Equal(0.0d, shape.Left);
            Assert.Equal(0.0d, shape.Top);
            Assert.Equal(WrapType.Inline, shape.WrapType);
            Assert.Equal(RelativeVerticalPosition.Paragraph, shape.RelativeVerticalPosition);
            Assert.Equal(RelativeHorizontalPosition.Column, shape.RelativeHorizontalPosition);
            ...
            Assert.Equal(400.0d, shape.Width);
            Assert.Equal(400.0d, shape.Height);
            Assert.Equal(-329.15d, shape.Left);
            Assert.Equal(-329.15d, shape.Top);
            Assert.Equal(WrapType.Square, shape.WrapType);
            Assert.Equal(RelativeVerticalPosition.BottomMargin, shape.RelativeVerticalPosition);
            Assert.Equal(RelativeHorizontalPosition.RightMargin, shape.RelativeHorizontalPosition);
