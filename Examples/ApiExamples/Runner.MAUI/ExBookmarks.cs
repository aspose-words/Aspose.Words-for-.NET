...
{
    public class ExBookmarks : Dirs, IClassFixture<ConfigureTestsFixture>
    {
        [Fact]
        public void Insert()
        {
            ...
            Assert.Equal("My Bookmark", doc.Range.Bookmarks[0].Name);
        ...
        public void CreateUpdateAndPrintBookmarks()
        {
            ...
            Assert.Equal(3, bookmarks.Count); //ExSkip
        ...
        public void TableColumnBookmarks()
        {
            ...
            Assert.Equal(1, firstTableColumnBookmark.FirstColumn);
            Assert.Equal(3, firstTableColumnBookmark.LastColumn);

            Assert.True(secondTableColumnBookmark.IsColumn);
            Assert.Equal(0, secondTableColumnBookmark.FirstColumn);
            Assert.Equal(3, secondTableColumnBookmark.LastColumn);
        }
        ...
        public void Remove()
        {
            ...
            Assert.DoesNotContain(bookmarks, b => b.Name == "MyBookmark_1");

            // 2 -  Passing the bookmark to the collection's Remove method:
            Bookmark bookmark = doc.Range.Bookmarks[0];
            doc.Range.Bookmarks.Remove(bookmark);

            Assert.DoesNotContain(bookmarks, b => b.Name == "MyBookmark_2");
            
            // 3 -  Removing a bookmark from the collection by name:
            doc.Range.Bookmarks.Remove("MyBookmark_3");

            Assert.DoesNotContain(bookmarks, b => b.Name == "MyBookmark_3");

            // 4 -  Removing a bookmark at an index in the bookmark collection:
            doc.Range.Bookmarks.RemoveAt(0);

            Assert.DoesNotContain(bookmarks, b => b.Name == "MyBookmark_4");
            ...
            Assert.Equal("Text inside MyBookmark_1.\r" +
