...
{
    public class ExCharts : Dirs, IClassFixture<ConfigureTestsFixture>
    {
        [Fact]
        public void ChartTitle()
        {
            ...
            Assert.Equal(ShapeType.NonPrimitive, chartShape.ShapeType);
            Assert.True(chartShape.HasChart);

            title = chartShape.Chart.Title;

            Assert.Equal("My Chart", title.Text);
        ...
        public void DataLabelNumberFormat()
        {
            ...
            Assert.Equal("\"US$\" #,##0.000\"M\"", series.DataLabels.NumberFormat.FormatCode);
        }
        ...
        public void DataArraysWrongSize()
        {
            ...
            Assert.Throws<ArgumentException>(() => seriesColl.Add("AW Series 3", categories, new[] { double.NaN, 4, 5, double.NaN, double.NaN }));
            Assert.Throws<ArgumentException>(() => seriesColl.Add("AW Series 4", categories, new[] { double.NaN, double.NaN, double.NaN, double.NaN, double.NaN }));
        }
        ...
        public void AxisProperties()
        {
            ...
            Assert.Equal(AxisCategoryType.Category, chart.AxisX.CategoryType);
            Assert.Equal(AxisCrosses.Minimum, chart.AxisX.Crosses);
            Assert.False(chart.AxisX.ReverseOrder);
            Assert.Equal(AxisTickMark.Inside, chart.AxisX.MajorTickMark);
            ...
            Assert.Equal(AxisCrosses.Maximum, chart.AxisY.Crosses);
            Assert.True(chart.AxisY.ReverseOrder);
            Assert.Equal(AxisTickMark.Inside, chart.AxisY.MajorTickMark);
        ...
        public void DateTimeValues()
        {
            ...
            Assert.Equal(new AxisBound(new DateTime(2017, 11, 05).ToOADate()), chart.AxisX.Scaling.Minimum);
            Assert.Equal(new AxisBound(new DateTime(2017, 12, 03)), chart.AxisX.Scaling.Maximum);
            Assert.Equal(AxisTimeUnit.Days, chart.AxisX.BaseTimeUnit);
            Assert.Equal(7.0d, chart.AxisX.MajorUnit);
            Assert.Equal(1.0d, chart.AxisX.MinorUnit);
            ...
            Assert.Equal(new AxisBound(100), chart.AxisY.Scaling.Minimum);
            Assert.Equal(new AxisBound(700), chart.AxisY.Scaling.Maximum);
        }
        ...
        public void SetNumberFormatToChartAxis()
        {
            ...
            Assert.Equal("#,##0", chart.AxisY.NumberFormat.FormatCode);
        }
        ...
        public void DataLabelsBubbleChart()
        {
            ...
            Assert.Equal(" & ", dataLabels.Separator);
        }
        ...
        public void DataLabels()
        {
            ...
            Assert.Equal("Series 3", chart.Series[2].Name);
            ...
            foreach (ChartSeries series in chart.Series)
            {
                ...
                Assert.Equal(4, series.DataLabels.Count);
            }
            ...
            using (IEnumerator<ChartDataLabel> enumerator = chart.Series[0].DataLabels.GetEnumerator())
            {
                ...
                {
                    Assert.Equal(", ", enumerator.Current.Separator);
        ...
        public void PieChartExplosion()
        {
            ...
            Assert.Equal(10, series.DataPoints[0].Explosion);
            Assert.Equal(40, series.DataPoints[1].Explosion);
        }
        ...
        public void Bubble3D()
        {
            ...
            Assert.Equal(1, chart.Series.Count);
            Assert.Equal("Y-Values", chart.Series[0].Name);
        ...
        public void ChartSeriesCollection()
        {
            ...
            Assert.Equal(ChartAxisType.Category, chart.AxisX.Type);
            Assert.Equal(ChartAxisType.Value, chart.AxisY.Type);
            ...
            Assert.Equal(ChartAxisType.Value, chart.AxisX.Type);
            Assert.Equal(ChartAxisType.Value, chart.AxisY.Type);
        ...
        private static Chart AppendChart(DocumentBuilder builder, ChartType chartType, double width, double height)
        {
            ...
            Chart chart = chartShape.Chart;
            chart.Series.Clear();
            Assert.Equal(0, chart.Series.Count); //ExSkip
        ...
        public void ChartSeriesCollectionModify()
        {
            ...
            Assert.Equal(3, chartData.Count);
            ...
            Assert.Equal(4, chartData.Count); //ExSkip
            Assert.Equal("Series 4", chartData[3].Name); //ExSkip
            
            // A chart series can also be removed by index, like this.
            // This will remove one of the three demo series that came with the chart.
            chartData.RemoveAt(2);

            Assert.DoesNotContain(chartData, s => s.Name == "Series 3");
            Assert.Equal(3, chartData.Count); //ExSkip
            Assert.Equal("Series 4", chartData[2].Name); //ExSkip
            ...
            chartData.Clear();
            Assert.Equal(0, chartData.Count); //ExSkip
        ...
        public void AxisScaling()
        {
            ...
            Assert.Equal(AxisScaleType.Linear, chart.AxisX.Scaling.Type);
            Assert.Equal(AxisScaleType.Logarithmic, chart.AxisY.Scaling.Type);
            Assert.Equal(20.0d, chart.AxisY.Scaling.LogBase);
        }
        ...
        public void AxisBound()
        {
            ...
            Assert.False(chart.AxisX.Scaling.Minimum.IsAuto);
            Assert.Equal(0.0d, chart.AxisX.Scaling.Minimum.Value);
            Assert.Equal(10.0d, chart.AxisX.Scaling.Maximum.Value);

            Assert.False(chart.AxisY.Scaling.Minimum.IsAuto);
            Assert.Equal(0.0d, chart.AxisY.Scaling.Minimum.Value);
            Assert.Equal(10.0d, chart.AxisY.Scaling.Maximum.Value);

            chart = ((Shape)doc.GetChild(NodeType.Shape, 1, true)).Chart;

            Assert.False(chart.AxisX.Scaling.Minimum.IsAuto);
            Assert.Equal(new AxisBound(new DateTime(1980, 1, 1)), chart.AxisX.Scaling.Minimum);
            Assert.Equal(new AxisBound(new DateTime(1990, 1, 1)), chart.AxisX.Scaling.Maximum);
        ...
        public void ChartLegend()
        {
            ...
            Assert.Equal(LegendPosition.TopRight, legend.Position);
        }
        ...
        public void AxisCross()
        {
            ...
            Assert.Equal(AxisCrosses.Custom, axis.Crosses);
            Assert.Equal(3.0d, axis.CrossesAt);
        }
        ...
        public void AxisDisplayUnit()
        {
            ...
            Assert.Equal(AxisBuiltInUnit.Custom, axis.DisplayUnit.Unit); //ExSkip
            ...
            Assert.Equal(450.0d, shape.Width);
            Assert.Equal(250.0d, shape.Height);

            axis = shape.Chart.AxisX;

            Assert.Equal(AxisTickMark.Inside, axis.MajorTickMark);
            Assert.Equal(AxisTickMark.Inside, axis.MinorTickMark);
            ...
            Assert.Equal(AxisTickMark.Cross, axis.MajorTickMark);
            Assert.Equal(AxisTickMark.Outside, axis.MinorTickMark);
            Assert.Equal(10.0d, axis.MajorUnit);
            Assert.Equal(1.0d, axis.MinorUnit);
            Assert.Equal(-10.0d, axis.Scaling.Minimum.Value);
            Assert.Equal(20.0d, axis.Scaling.Maximum.Value);
        }
        ...
        public void MarkerFormatting()
        {
            ...
            dataPoints[0].Marker.Format.Stroke.ForeColor = System.Drawing.Color.Yellow;
            dataPoints[0].Marker.Format.Stroke.BackColor = System.Drawing.Color.Red;
            dataPoints[1].Marker.Format.Fill.PresetTextured(PresetTexture.WaterDroplets);
            dataPoints[1].Marker.Format.Stroke.ForeColor = System.Drawing.Color.Yellow;
            dataPoints[1].Marker.Format.Stroke.Visible = false;
            dataPoints[2].Marker.Format.Fill.PresetTextured(PresetTexture.GreenMarble);
            dataPoints[2].Marker.Format.Stroke.ForeColor = System.Drawing.Color.Yellow;
            dataPoints[3].Marker.Format.Fill.PresetTextured(PresetTexture.Oak);
            dataPoints[3].Marker.Format.Stroke.ForeColor = System.Drawing.Color.Yellow;
        ...
        public void SeriesColor()
        {
            ...
            series2.Format.Fill.ForeColor = System.Drawing.Color.Yellow;
            series3.Format.Fill.ForeColor = System.Drawing.Color.Blue;
        ...
        public void DataPointsFormatting()
        {
            ...
            dataPoints[1].Format.Fill.ForeColor = System.Drawing.Color.Red;
            dataPoints[2].Format.Fill.ForeColor = System.Drawing.Color.Yellow;
            dataPoints[3].Format.Fill.ForeColor = System.Drawing.Color.Blue;
