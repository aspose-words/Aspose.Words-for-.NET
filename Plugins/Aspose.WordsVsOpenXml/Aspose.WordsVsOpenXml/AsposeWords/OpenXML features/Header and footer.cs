...
namespace AsposeWordsVSOpenXML.OpenXML_features
{
    ...
    {
        [Test]
        //ExStart:CreateHeaderFooterOpenXml
        //GistDesc:Change or replace header and footer using C#
        public void CreateHeaderFooterOpenXml()
        {
        ...
        //ExEnd:CreateHeaderFooterOpenXml
    }
}
