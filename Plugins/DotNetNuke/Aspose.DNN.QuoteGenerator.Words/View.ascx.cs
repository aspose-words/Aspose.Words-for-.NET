...
using Aspose.DotNetNuke.Modules.DNNQuoteGenerator;
using Aspose.Words;
...
namespace Aspose.DotNetNuke.Modules.AsposeDNNQuoteGeneratorWord
{
    ...
    public partial class View : AsposeDNNQuoteGeneratorModuleBase, IActionable
    {
        ...
        private string GetDataDir_Templates()
        {
            try
            {
                ...
                if (!System.IO.Directory.Exists(Server.MapPath("~/DesktopModules/Aspose.DNN.QuoteGenerator.Word/Templates/")))
                {
                    // create directory if missing
                    System.IO.Directory.CreateDirectory(Server.MapPath("~/DesktopModules/Aspose.DNN.QuoteGenerator.Word/Templates/"));
                }
                return "~/DesktopModules/Aspose.DNN.QuoteGenerator.Word/Templates/";
            }
            catch (Exception exc)
            {
                lblMessage.Text = exc.Message;
        ...
        private string GetDataDir_LogoImages()
        {
            ...
            {
                // check if directory exist
                if (!System.IO.Directory.Exists(Server.MapPath("~/DesktopModules/Aspose.DNN.QuoteGenerator.Word/UploadedImages/")))
                {
                    // create directory if missing
                    System.IO.Directory.CreateDirectory(Server.MapPath("~/DesktopModules/Aspose.DNN.QuoteGenerator.Word/UploadedImages/"));
                }
                return "~/DesktopModules/Aspose.DNN.QuoteGenerator.Word/UploadedImages/";
            }
            catch (Exception exc)
            {
                lblMessage.Text = exc.Message;
        ...
        private string GetDataDir_OutputDocs()
        {
            ...
            {
                // check if directory exist
                if (!System.IO.Directory.Exists(Server.MapPath("~/DesktopModules/Aspose.DNN.QuoteGenerator.Word/OutputDocs/")))
                {
                    // create directory if missing
                    System.IO.Directory.CreateDirectory(Server.MapPath("~/DesktopModules/Aspose.DNN.QuoteGenerator.Word/OutputDocs/"));
                }
                return "~/DesktopModules/Aspose.DNN.QuoteGenerator.Word/OutputDocs/";
            }
            catch (Exception exc)
            {
                lblMessage.Text = exc.Message;
