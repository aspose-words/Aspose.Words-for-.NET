...
namespace Aspose.DotNetNuke.Modules.Aspose.DNN.ExportUsersAndRolesToWord.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "Aspose.DotNetNuke.Modules.Aspose.DNN.ExportUsersAndRolesToWord.Data.SqlDataprovider,Aspose.DNN.ExportUsersAndRolesToWord";
