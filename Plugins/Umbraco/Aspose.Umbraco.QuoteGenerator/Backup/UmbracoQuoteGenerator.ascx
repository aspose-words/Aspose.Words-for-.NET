...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UmbracoQuoteGenerator.ascx.cs"
    Inherits="Aspose.UmbracoQuoteGenerator.UmbracoQuoteGenerator" %>
<link href="/UserControls/Aspose.UmbracoQuoteGenerator/Css/UmbracoQuoteGenerator.css"
                    ...
                    <tr>
                        <td colspan="2">
                            <table width="100%">
                                <tr>
                                    <td width="35%">
                                        Document Caption (Quote/Invoice/Other)<br />
                        ...
                        <td colspan="2" align="right">
                            ...
                            <p>
                                This is created to demonstrate the <a href="http://www.aspose.com/.net/word-component.aspx"
                                    title="Aspose.Words for .Net (Umbraco)" target="_blank">Aspose.Words for .Net (Umbraco)</a>.
                            </p>
                        </td>
                    </tr>
                </table>
